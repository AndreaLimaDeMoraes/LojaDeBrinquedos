  ...
  return (
    <footer style={{ 
      ...
      <div style={{
        ...
        <div>
          <h4>BrincaMundo</h4>
          <p>Levando alegria e diversão para crianças de todas as idades desde 2020.</p>
        </div>
        <div>
          <h4>Institucional</h4>
          ...
          <a href="#" style={{ display: 'block', color: 'white', textDecoration: 'none', marginBottom: '0.5rem' }}>Trabalhe conosco</a>
        </div>
        <div>
          <h4>Atendimento</h4>
      ...
      <div style={{ 
        ...
        <p>&copy; 2026 BrincaMundo - Todos os direitos reservados</p>
      </div>
    </footer>
  );
};
